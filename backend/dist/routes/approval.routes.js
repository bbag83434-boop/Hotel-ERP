...
// Summary Metrics
router.get('/summary', approval_controller_1.ApprovalController.getSummary);
// Requests Queue
...
router.put('/rules/:id', (0, rbac_middleware_1.requirePermission)('approval:manage'), approval_controller_1.ApprovalController.updateRule);
router.delete('/rules/:id', (0, rbac_middleware_1.requirePermission)('approval:manage'), approval_controller_1.ApprovalController.deleteRule);
