...
class Recipe(BaseModel):
    ...
    # User-entered selling price per finished unit — NEVER auto-overwritten by ingredient rate changes
    selling_price_per_unit = Column("sellingPricePerUnit", Numeric(14, 4), default=Decimal("0.0000"), nullable=False)
    ...
    sellingPricePerUnit = synonym("selling_price_per_unit")
