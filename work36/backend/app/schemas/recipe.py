...
class RecipeBase(BaseModel):
    ...
    is_active: bool = True
    # User-entered selling price — never auto-overwritten by ingredient rate changes
    selling_price_per_unit: Decimal = Decimal("0.0000")
...
class RecipeUpdate(BaseModel):
    ...
    # Selling price update (optional; user controls this, not auto-computed)
...
class RecipeResponse(RecipeBase):
    ...
    unit_cost: Decimal = Decimal("0.0000")
    # Selling price and margin — computed on the fly from stored selling_price_per_unit
    selling_price_per_unit: Decimal = Decimal("0.0000")
    expected_sales_value: Decimal = Decimal("0.0000")
    gross_profit: Decimal = Decimal("0.0000")
